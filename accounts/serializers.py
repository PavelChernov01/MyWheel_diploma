...
class UserProfileUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'phone', 'avatar', 'city')from rest_framework import serializers
from django.contrib.auth import get_user_model
from django.contrib.auth.password_validation import validate_password
from rest_framework_simplejwt.tokens import RefreshToken
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'email', 'username', 'first_name', 'last_name', 'phone', 'avatar', 'city', 'rating', 'total_reviews', 'date_joined')
        read_only_fields = ('id', 'email', 'rating', 'total_reviews', 'date_joined')
